...
@Composable
fun RegistrationScreenPassword(
    ...
    RegistrationMainPassword(
        viewModel = viewModel,
        onClickNextStep = {
            println(viewModel.regEmail)
            println(viewModel.regPassword)
            println(viewModel.repPassword)
...
@Composable
private fun RegistrationMainPassword(
    ...
    Box(modifier = Modifier
        ...
        Box(modifier = Modifier
            ...
            AuthComponent {
                ...
                RegistrationLineComponent(iconRegScreen = painterResource(MeatViceIcons.Password), stage = 2)
            }
        }
    }
}
